...
function business() {
  return (
    <div className="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s" id="business">
            ...
            <ReactOwlCarousel className="testimonial-carousel position-relative" items={2} center = {true} loop = {true} margin={20}>
                ...
                <div className="testimonial-item text-center item">
                    ...
                    <div className="text-center p-4 pb-0">
                        ...
                        <h5 className="mb-4">Specialized Fields</h5>
                    </div>
                ...
                <div className="testimonial-item text-center item">
                    ...
                    <div className="text-center p-4 pb-0">
                        ...
                        <h5 className="mb-4">Commercial English</h5>
                    </div>
                    <div className="d-flex border-top">
                        <small className="flex-fill text-center border-end py-2"><i className="fa fa-user-tie text-primary me-2"></i>John Doe</small>
                        <small className="flex-fill text-center border-end py-2"><i className="fa fa-clock text-primary me-2"></i>1.49 Hrs</small>
